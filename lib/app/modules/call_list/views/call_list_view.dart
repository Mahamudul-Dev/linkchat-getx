...
import 'package:linkchat/app/modules/call_list/views/call_list_tile_view.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
          ...
          return controller.callHistory.isNotEmpty
              ...
              : Center(
                  child: Column(
                    ...
                    children: [
                      Lottie.asset(AssetManager.HISTORY_ANIM,
                          height: 150),
                      Text(
        ...
        floatingActionButton: FloatingActionButton.extended(
          ...
          label: Row(
            children: [
              Lottie.asset(AssetManager.CALL_ICON_ANIM,
                  height: 30, width: 30),
              const Text(
                'Make Call',
                style:
